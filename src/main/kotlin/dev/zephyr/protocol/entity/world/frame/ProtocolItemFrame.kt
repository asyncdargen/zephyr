...
@KotlinOpens
class ProtocolItemFrame(location: Location, direction: EntityDirection = EntityDirection.UP, type: EntityType = EntityType.ITEM_FRAME) : ProtocolEntity(type, direction.ordinal, location) {
